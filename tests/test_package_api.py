"""Tests for the public API surface of qsp.fft."""
...
def test_all_list_matches_importable_names():
    ...
    for name in qsp.fft.__all__:
        assert hasattr(qsp.fft, name), f"{name!r} is in __all__ but not in package"
